        ...
        $.ajax({
            ...
            success: function(response) {
                if (response['editCode'] == 1) {
                    ...
                    self.location.href = manageweight;
                } else {
                    var str = "";
                    for (var i in response) {
                        str += response[i] + "\n";
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response['deleteCode'] == 1) {
                        ...
                        $('table#weightmanage').find('tr.weight').eq(liid).remove();
                    } else {
